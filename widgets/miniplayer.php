...
<div class="widget" id="miniplayer-widget">
    ...
    <div class="widget-content miniplayer-content">
        ...
        <div id="miniplayer-empty-state" class="text-center">
            ...
            <p style="color: var(--text-secondary); margin-top: 8px;">Nenhum vídeo carregado</p>
        </div>

        <!-- Add Link Form -->
        <div class="miniplayer-form" style="margin-top: 1rem;">
            <div style="display: flex; gap: 8px;">
                <input type="url" id="miniplayer-input" class="form-control" placeholder="Cole o link do YouTube..." style="flex: 1;">
                <button id="miniplayer-add-btn" class="btn btn-primary" title="Adicionar à Playlist">
        ...
        <div class="miniplayer-playlist-container" style="margin-top: 1rem;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
                <h3 style="font-size: 0.9rem; color: var(--text-secondary); margin: 0;">Fila de Reprodução</h3>
                <button id="miniplayer-clear-btn" class="icon-btn" title="Limpar Lista" style="color: var(--text-secondary); width: 24px; height: 24px;">
