...
<div class="widget" id="search-widget">
    <div class="widget-header">
        <h2><span class="material-icons-round">travel_explore</span> <?= i18n($user_lang, 'search') ?></h2>
    </div>
    <div class="widget-content" style="display: flex; flex-direction: column; justify-content: center; min-height: 100px;">
        <form id="search-form" action="https://duckduckgo.com/" method="GET" target="_blank" style="width: 100%; display: flex; flex-direction: column; gap: 12px; align-items: stretch;">
            ...
            <select id="search-engine-select" aria-label="Provedor de <?= i18n($user_lang, 'search') ?>" style="width: 100%; padding: 10px 12px; border-radius: var(--border-radius-sm); background: rgba(0,0,0,0.1); color: var(--text-primary); border: 1px solid var(--border-color); font-size: 0.95rem; cursor: pointer; outline: none; appearance: auto; -webkit-appearance: auto;">
            ...
            <div style="display: flex; gap: 8px; width: 100%;">
                <div style="position: relative; flex: 1; display: flex;">
                    <input type="text" name="q" id="search-input" placeholder="<?= i18n($user_lang, 'search_placeholder') ?>" required
                ...
                <button type="submit" class="btn btn-primary" aria-label="<?= i18n($user_lang, 'search_btn') ?>" style="padding: 0 16px; display: flex; align-items: center; justify-content: center;">
