...
<div class="widget" id="shortener-widget">
    <div class="widget-header">
        <h2><span class="material-icons-round">link</span> <?= i18n($user_lang, 'shorten_url') ?></h2>
    </div>
        ...
        <form id="shortener-form" style="width: 100%; display: flex; flex-direction: column; gap: 12px; align-items: stretch;" onsubmit="return false;">
            ...
            <div style="display: flex; gap: 8px; width: 100%;">
                <div style="position: relative; flex: 1; display: flex;">
                    <input type="url" id="shortener-input" placeholder="<?= i18n($user_lang, 'shortener_placeholder') ?>" required
                ...
                <button type="submit" id="shortener-submit-btn" class="btn btn-primary" aria-label="<?= i18n($user_lang, 'shorten') ?>" style="padding: 0 16px; display: flex; align-items: center; justify-content: center;">
            ...
            <div id="shortener-result-container" style="display: none; flex-direction: column; gap: 8px;">
                <div id="shortener-result-row" style="display: flex; gap: 8px; width: 100%;">
                    ...
                    <button type="button" id="shortener-copy-btn" class="btn" aria-label="<?= i18n($user_lang, 'copy') ?>" style="padding: 0 16px; display: flex; align-items: center; justify-content: center; background: rgba(255,255,255,0.1); border: 1px solid var(--border-color); border-radius: var(--border-radius-sm); color: var(--text-primary); cursor: pointer;">
            ...
            <div style="text-align: center; margin-top: 4px;">
                <span style="font-size: 0.8rem; color: var(--text-secondary);">
                    <?= i18n($user_lang, 'via_central_link') ?> <a href="https://ctln.link/" target="_blank" style="color: var(--text-primary); text-decoration: none; font-weight: 500;">Central Link</a>
                </span>
            </div>
        </form>
    </div>
